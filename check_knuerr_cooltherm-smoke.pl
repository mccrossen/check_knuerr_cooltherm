...
humidity, smoke, smoke, fan and humidity. Temperature and humidity values
...
sub checkStati {
	...
	my $statesmoke = $result{$smokealert} == 0 ? 'OK' : 'CRITICAL';

	raiseGlobalState($statesmoke);
